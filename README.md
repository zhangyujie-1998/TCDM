...
This respository is about a full-reference point cloud quality metric based on transformational complexity. The key idea is that **the quality of one distorted point cloud can be quantified as the complexity or the amount of effort of transforming it into its corresponding reference**.
